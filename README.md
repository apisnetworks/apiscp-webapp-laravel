...
This is a native module for Laravel on ApisCP. Native modules are shipped with ApisCP
...
git clone https://github.com/apisnetworks/apiscp-webapp-laravel config/custom/webapps/laravel
